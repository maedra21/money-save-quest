...
const translations = {
  en: {
    ...
    "settings.goal.amount": "Target amount",
    "settings.set": "Set",
    "settings.clear": "Clear goal",
    "settings.reset": "Reset all data",
    "settings.reset.title": "Reset all data?",
    "settings.reset.desc": "This will permanently delete all your savings history, streaks, and achievements. This action cannot be undone.",
  ...
  ru: {
    ...
    "settings.goal.amount": "Целевая сумма",
    "settings.set": "Задать",
    "settings.clear": "Сбросить цель",
    "settings.reset": "Сбросить все данные",
    "settings.reset.title": "Сбросить все данные?",
    "settings.reset.desc": "Это навсегда удалит всю историю экономий, серии и достижения. Это действие нельзя отменить.",
    "settings.reset.confirm": "Удалить всё",
